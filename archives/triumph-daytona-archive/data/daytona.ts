...
export const models: DaytonaModel[] = [
  ...
  },
  {
    ...
    engine: "水冷直列三缸",
    family: "triple",
    position: "Daytona 675 車系起點",
    summary:
      "675cc 三缸中量級仿賽誕生，採用座墊下方高位排氣。Triumph 以不同於日本 600 四缸的方式重新切入中量級跑車市場，建立 Daytona 675 獨特的三缸仿賽路線。",
    difference:
      "座墊下方高位排氣、初代車頭與整流罩、675cc 直列三缸，是辨識這批車與後續世代的主要特徵。",
    significance:
      "Daytona 675 車系由此開始；675 是車系本體，後來的 675R 則是建立在同一車系上的高規版本。",
    image: "/images/motorcycles/daytona660/TriumphDaytona675Side.jpg",
    imageFit: "contain",
    imageAlt: "2008—2009 Triumph Daytona 675 高位排氣車型側面",
    imageCredit: "LFX 提供",
    imageLicense: "本機既有圖片",
    imageSource: "/images/motorcycles/daytona660/TriumphDaytona675Side.jpg",
    sourceLabel: "Triumph：Our Story",
    sourceUrl: "https://www.triumphmotorcycles.com/our-story",
  },
  {
    id: "daytona-675-mid-update",
    year: "2009—2012",
    eyebrow: "GEN 1 MID-CYCLE UPDATE",
    name: "Daytona 675・初代中期改款",
    capacity: "675 cc",
    engine: "水冷直列三缸",
    family: "triple",
    position: "高位排氣初代的中期進化",
    summary:
      "延續初代高位排氣架構，但外觀細節、引擎輸出、重量與賽道支援進一步更新。雖然部分車友會把這批稱為 Gen2，但在圖鑑中建議稱為初代中期改款，避免和 2013 的真正大改款混淆。",
    difference:
      "仍為座墊下方高位排氣，外觀線條更銳利，引擎與車重細節更新，也開始更明確支援快排等賽道化配件。",
    significance:
      "2009 是中期改款而非完整換代；675 是本體，675R 是高規版，2013 才是真正大換代。",
    image: "/images/motorcycles/daytona660/Triumph_Daytona_675_2009.jpg",
    imageFit: "contain",
    imageAlt: "2009—2012 Triumph Daytona 675 初代中期改款",
    imageCredit: "LFX 提供",
    imageLicense: "本機既有圖片",
    imageSource: "/images/motorcycles/daytona660/Triumph_Daytona_675_2009.jpg",
    sourceLabel: "Triumph：Brand Timeline",
    sourceUrl: "https://www.triumphmotorcycles.com/our-story/brand-timeline",
  },
  {
    id: "daytona-675r-stage1",
    year: "2011—2012",
    eyebrow: "R-SPEC BRANCH · NOT A GENERATION",
    name: "Daytona 675R・第一階段 R 版",
    capacity: "675 cc",
    engine: "水冷直列三缸",
    family: "triple",
    position: "依附初代中期改款的 R 版支線，不是新世代",
    summary:
      "Daytona 675R 是 Daytona 675 的高規賽道版，不是新世代。它以中期改款 Daytona 675 為基礎，加入 Öhlins、Brembo、快排等高階部品，讓 675 更接近賽道取向。",
    difference:
      "高排氣、Öhlins 金色前叉、Brembo 煞車與高規賽道配備，是第一階段 R 版的辨識重點。",
    significance:
      "675R 是高規版本，並非 Gen2；它會隨 Daytona 675 的世代基礎一起演進。",
    image: "/images/motorcycles/daytona660/1714072812-triumph-daytona-675r-used-buyers-guide-1.avif",
    images: [
      "/images/motorcycles/daytona660/1714072812-triumph-daytona-675r-used-buyers-guide-1.avif",
      "/images/motorcycles/daytona660/1714120720-triumph-daytona-675r-used-buyers-guide-3.avif",
      "/images/motorcycles/daytona660/1714120720-triumph-daytona-675r-used-buyers-guide-5.avif",
    ],
    imageAlt: "2011—2012 Triumph Daytona 675R 第一階段 R 版",
    imageCredit: "LFX 提供",
    imageLicense: "本機既有圖片",
    imageSource: "/images/motorcycles/daytona660/1714072812-triumph-daytona-675r-used-buyers-guide-1.avif",
    sourceLabel: "Triumph 原廠輪胎年式表",
    sourceUrl:
      "https://www.triumphmotorcycles.com/media-library/7b5bb1aeb714454ebb19829bc799622a.pdf?la=en-US",
  },
  {
    ...
    name: "Daytona 675 / 675R・第二代大改款",
    capacity: "675 cc",
    engine: "水冷直列三缸",
    family: "triple",
    position: "真正大改款的第二代 675 車系",
    summary:
      "2013 年 Daytona 675 進入真正大改款。新引擎、新車架、新車身與低位排氣，讓它和 2006—2012 的高位排氣世代明顯分開。2013 之後的 675R 則是第二代基礎上的高規賽道版。",
    difference:
      "低位排氣、新車架、新車身與明顯改變的車身比例，是第二代重點；675R 另有紅色副車架、Öhlins 與 Brembo 等高規特徵。",
    significance:
      "675 是本體，675R 是高規版；2009 是中期改款，2013 才是真正大換代。",
    image: "/images/motorcycles/daytona660/3986.jpg",
    images: [
      "/images/motorcycles/daytona660/3986.jpg",
      "/images/motorcycles/daytona660/3983.jpg",
      "/images/motorcycles/daytona660/3977.jpg",
      "/images/motorcycles/daytona660/3980.jpg",
    ],
    imageFit: "contain",
    imageAlt: "2013—2017 Triumph Daytona 675R 第二代低位排氣車型",
    imageCredit: "LFX 提供",
    imageLicense: "本機既有圖片",
    imageSource: "/images/motorcycles/daytona660/3986.jpg",
    sourceLabel: "Triumph 原廠輪胎年式表",
    sourceUrl:
      "https://www.triumphmotorcycles.com/media-library/7b5bb1aeb714454ebb19829bc799622a.pdf?la=en-US",
  },
