...
// ============================================================
// 我的電腦 — My Setup 區塊
// 規格來源：使用者提供的配備清單（records/computer/4070TIS.xlsx）。
...
export const computerJournal = {
  ...
  entries: [
    ...
    {
      image: "/images/COMPUTER/IMAG0298.jpg",
      alt: "電腦の手帖：統測結束那晚電腦復活",
      caption: "統測結束的那晚，電腦復活。",
      date: "2019/05/05",
      aspect: "16 / 9",
      wide: true,
    },
    {
      image: "/images/COMPUTER/IMAG0447.jpg",
      alt: "電腦の手帖：第一次大升級 i7-8700、ROG Strix GTX 1660 Ti 與 ROG STRIX Z390-F",
      caption:
        "第一次大升級。i7-8700、ROG Strix GTX 1660 Ti 與 ROG STRIX Z390-F，從這次開始硬體規格真正往上跨一階。",
      date: "2019/07/11",
      aspect: "16 / 9",
      wide: true,
    },
    {
      ...
      alt: "電腦の手帖：弟弟暑假把電腦搬來家裡變成網咖",
      caption: "弟弟暑假時把電腦搬來我家，房間直接變成網咖。那時候超開心。",
      date: "2019/08/19",
      aspect: "16 / 9",
      wide: true,
    },
    {
      image: "/images/COMPUTER/IMG_1060.jpg",
      alt: "電腦の手帖：暑假在叔叔家和弟弟繼續經營網咖",
      caption: "暑假躲到叔叔家，跟弟弟繼續經營網咖。",
      date: "2020/07/21",
      aspect: "4 / 3",
      wide: true,
    },
    ...
    {
      image: "/images/COMPUTER/IMG_4539.JPG",
      alt: "電腦の手帖：高雄舊機 ROG 顯示卡交接儀式",
      caption: "高雄舊機顯卡交接儀式：從鄰居借來的 ROG GTX 1050 Ti，換成收到的 ROG RX 6650 XT V2。",
      date: "2026/06/18",
      aspect: "3 / 4",
      wide: false,
    },
